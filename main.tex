...
{\begin{itemize}
  \item Researched and implemented novel data formats and quantization algorithms for deep neural networks, targeting specialized hardware.
...
{\begin{itemize}
  ...
  \item Proposed a new method to automatically determine the optimal bit-width for each layer in a quantized DNN.
\end{itemize}
}
}
