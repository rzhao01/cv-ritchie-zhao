...
\address{16212 NE 57th Street}{Redmond, WA 98052}{USA}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\vspace{-1mm}
Hardware acceleration for machine learning, efficient neural network training and inference, neural network quantization, high-level synthesis (HLS) for FPGAs
...
{\customcvproject{DNN Quantization with Outlier Channel Splitting [1]}{Aug 2018 - Feb 2019}
  {\begin{itemize}
    ...
    \item Results show improved accuracy over state-of-the-art clipping methods. Open-source code available at https://github.com/cornell-zhang/dnn-quant-ocs.
  \end{itemize}
  }
}
...
{\begin{itemize}
  \item Researched and prototyped novel techniques to quantize DNNs for efficient deployment on the Brainwave FPGA accelerator system. Gathered experimental data on the quantized accuracy of internal models and contributed to the first technical publication of Brainwave [3].
